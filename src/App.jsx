  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section id="contact" className="section-wrap contact-section"><div className="contact-card"><div><p className="eyebrow">05 / Contact</p><h2>Have a system<br /><span>worth building?</span></h2><p>Let&apos;s talk about how we can turn your next big idea into reliable, intelligent software.</p></div><div className="contact-actions"><a className="button button-primary" href="https://mail.google.com/mail/?view=cm&fs=1&to=babeltranavila@gmail.com" target="_blank" rel="noreferrer" aria-label="Start a conversation by email">Start a conversation <ArrowUpRight /></a><button className="email-copy" onClick={copyEmail}>{copied ? <Check /> : <Mail />} {copied ? 'Copied' : 'babeltranavila@gmail.com'}</button></div></div></section>
      </main>
